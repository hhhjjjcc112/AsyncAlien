...
#[derive(Debug, Clone)]
pub struct IndexAllocator<const MAX_INDEX: usize, const SIZE: usize = { (MAX_INDEX + 64) / 64 }>
{
    map: [u64; SIZE],
...
impl<const MAX_INDEX: usize, const SIZE: usize> Display for IndexAllocator<MAX_INDEX, SIZE>
{
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
...
impl<const MAX_INDEX: usize, const SIZE: usize> Default for IndexAllocator<MAX_INDEX, SIZE>
where
    [(); SIZE]:,
{
    fn default() -> Self {
...
impl<const MAX_INDEX: usize, const SIZE: usize> IndexAllocator<MAX_INDEX, SIZE>
where
    [(); SIZE]:,
{
    ...
    pub fn allocate(&mut self) -> Result<usize> {
        let r = self.current_allocation / 64..SIZE;
