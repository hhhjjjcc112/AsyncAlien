    ...
    #[cfg(plat_vf2)]
    {
        #[cfg(not(plat_vf2_sd))]
        {
            ...
            let info = CommonDeviceInfo {
                ...
                locator: DeviceLocator::Mmio(
                    mem::PhysAddr::from(ramdisk_start)
                        ..mem::PhysAddr::from(ramdisk_start + len),
                ),
                irq: None,
                compatible: None,
        ...
        let fake_nic = CommonDeviceInfo {
            ...
            locator: DeviceLocator::Mmio(mem::PhysAddr::from(0)..mem::PhysAddr::from(0)),
            irq: Some(0),
            compatible: None,
        };
